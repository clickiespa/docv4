...
### `devices`
- [Devices endpoints](Devices/devices.md) — device CRUD, bounded incremental
  reads with `updated_at_from`/cursor, and related operations.
